...
const projects: TProject[] = [
  {
    name: "QuickCart – Modern E-commerce ",
    description:
      "An open-source, responsive eCommerce frontend built with Next.js and Tailwind CSS — designed as a ready-to-use shopping UI. ",
    tags: [
      {
        name: "react",
    ...
    image: carrent,
    sourceCodeLink: "https://quickcart.greatstack.in/",
  },
  {
    name: "QuickShow — Movie Ticket Booking App",
    description:
      "Full-stack movie ticket booking application with real-time seat selection, secure payments and admin dashboard.",
    tags: [
      {
        name: "react",
        color: "blue-text-gradient",
    ...
    image: jobit,
    sourceCodeLink: "https://quickshow.vercel.app/",
  },
  {
    name: "GreenCart – Full-Stack Grocery Web App",
    description:
      "A complete online grocery shopping platform built with MERN stack; users can browse products, add to cart, and checkout — with full CRUD & order management.",
    tags: [
      {
        name: "nextjs",
        color: "blue-text-gradient",
    ...
    image: tripguide,
    sourceCodeLink: "https://greencart-gs.vercel.app/",
  },
];
